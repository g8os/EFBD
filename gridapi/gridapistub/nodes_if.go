...
func NodesInterfaceRoutes(r *mux.Router, i NodesInterface) {
	...
	r.HandleFunc("/nodes/{nodeid}/containers/{containerid}/jobs/{jobid}", i.SendSignalToJob).Methods("POST")
	...
	r.HandleFunc("/nodes/{nodeid}/containers/{containerid}/processes/{processid}", i.SendSignalToProcess).Methods("POST")
