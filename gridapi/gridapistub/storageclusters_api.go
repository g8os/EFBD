...
type StorageclustersAPI struct {
	MetadataServer HAStorageServer
	StorageServers []HAStorageServer
}
...
func (api StorageclustersAPI) GetClusterInfo(w http.ResponseWriter, r *http.Request) {
	...
	respBody.MetadataStorage = []HAStorageServer{api.MetadataServer}
	respBody.DataStorage = api.StorageServers
