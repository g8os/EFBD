...
// SendSignalToJob is the handler for POST /nodes/{nodeid}/containers/{containerid}/jobs
...
// GetContainerProcess is the handler for GET /nodes/{nodeid}/containers/{containerid}/processes/{proccessid}
// Get process details
...
// SendSignalToProcess is the handler for POST /nodes/{nodeid}/containers/{containerid}/processes/{proccessid}
...
// KillContainerProcess is the handler for DELETE /nodes/{nodeid}/containers/{containerid}/processes/{proccessid}
// Kill Process
...
// GetNodeProcess is the handler for GET /nodes/{nodeid}/processes/{proccessid}
// Get process details
...
// KillNodeProcess is the handler for DELETE /nodes/{nodeid}/processes/{proccessid}
// Kill Process
...
func (api NodesAPI) GetStoragePools(w http.ResponseWriter, r *http.Request) {
