...
type NodesInterface interface { // ListNodes is the handler for GET /nodes
	// List Nodes
...
func NodesInterfaceRoutes(r *mux.Router, i NodesInterface) {
	...
	r.HandleFunc("/nodes/{nodeid}/storagepools", i.GetStoragePools).Methods("GET")
	...
	r.HandleFunc("/nodes/{nodeid}/containers/{containerid}/jobs", i.SendSignalToJob).Methods("POST")
	...
	r.HandleFunc("/nodes/{nodeid}/containers/{containerid}/processes/{proccessid}", i.SendSignalToProcess).Methods("POST")
